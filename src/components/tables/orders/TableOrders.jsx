            ...
            {paginatedData.length === 0 ? (
              ...
              paginatedData.map((item, index) => (
                ...
                >
                  ...
                  {/* Trabajador */}
                  <td data-th="Trabajador" className="block lg:table-cell px-4 py-4 text-sm whitespace-nowrap lg:!bg-inherit bg-gray-50 dark:bg-gray-800 text-center" >
                    <div className="flex justify-between items-center lg:block gap-2">
                      <span className="text-gray-400 lg:hidden">Trabajador</span>
                      <span className="dark:text-white">{item.usuario.username}</span>
                    </div>
                  </td>
