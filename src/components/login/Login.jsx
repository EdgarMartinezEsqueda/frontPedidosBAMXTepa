    ...
    return (
      ...
      <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto lg:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
        <div className="w-full h-100">
          ...
          <h2 className="text-xl md:text-3xl font-bold leading-tight mt-12">Inicia sesión con  tu cuenta</h2>
          <form className="mt-6" action="#" method="POST">
            ...
            <button type="submit" className="w-full block bg-blue-500 hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold rounded-lg px-4 py-3 mt-6">Iniciar sesión</button>
          </form>
          <p className="mt-8">¿No tienes una cuenta? <a href="/registro" className="text-blue-500 hover:text-blue-700 font-semibold">Únete</a> </p>
